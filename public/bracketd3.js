...
var getChildren = function(d){
      ...
      if(d.winners2) for(var i = 0; i < d.winners2.length; i++){
        d.winners2[i].isRight = true;
        d.winners2[i].parent = d;
        a.push(d.winners2[i]);
      }
...
d3.json("bracket.json", function(json) {
  ...
  var t1 = d3.layout.tree().size([height, halfWidth]).children(function(d){return d.winners;}),
      t2 = d3.layout.tree().size([height, halfWidth]).children(function(d){return d.winners2;});
  t1.nodes(root);
  t2.nodes(root);
